...
LoginInfo LoginManager::fetch_Linfo_by_login
(std::string login){
...
LoginInfo LoginManager::fetch_Linfo_by_l_id
(int l_id){
  LoginInfo login_info_from_db = LoginInfo();
...
CustomerInfo CustomerManager::fetch_Cinfo_by_l_id
(int l_id){
...
VenderInfo VenderManager::fetch_Cinfo_by_l_id(int l_id){
