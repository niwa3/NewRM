...
bool CustomerManageFuncs::register_Cinfo(
    int l_id,
...
bool DeviceManageFuncs::register_Dinfo(
    int c_id,
...
bool VenderManageFuncs::register_Vinfo(
    int l_id,
    std::string name,
    std::string phone_num,
    std::string e_mail_addr)
...
bool ServiceManageFuncs::register_Sinfo(
    int v_id,
